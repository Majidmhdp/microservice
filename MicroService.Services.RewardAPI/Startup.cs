...
using MicroService.Services.RewardAPI.Extention;
using MicroService.Services.RewardAPI.Messaging;
using MicroService.Services.RewardAPI.Service;
using Microsoft.EntityFrameworkCore;

namespace MicroService.Services.RewardAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "MicroService.Services.RewardAPI", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "MicroService.Services.RewardAPI v1"));
            }
